...
parser.add_argument('--lat', required=True, help="Your pet latitude, a double precision number. Ex: 41.4356345")
parser.add_argument('--long', required=True, help="Your pet longitude, a double precision number. Ex: 41.4356345")
